      ...
      \resumeSubSubheading
        ...
        \resumeItemListStart
          \resumeItem{Shopify Markets \& Infrastructure}
            {Led implementation of complex \textbf{Shopify Markets} feature in Wishlist Plus application, onboarding real merchants. Led infrastructure initiatives including \textbf{Kubernetes} migration and \textbf{MongoDB} 6.0 to 7.0 upgrade. Worked on cost-cutting initiatives by optimizing \textbf{MongoDB} data management through TTLs, indices, and pruning older data, saving \textbf{\$1,200/month}.}
